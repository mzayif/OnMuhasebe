    ...
    public partial class AllEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppKasaler", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppKasaler_AppOzelKodlar_OzelKod1Id",
                        column: x => x.OzelKod1Id,
                        principalTable: "AppOzelKodlar",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppKasaler_AppOzelKodlar_OzelKod2Id",
                        column: x => x.OzelKod2Id,
                        principalTable: "AppOzelKodlar",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppKasaler_AppSubeler_SubeId",
                        column: x => x.SubeId,
                        principalTable: "AppSubeler",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirimFiyat = table.Column<decimal>(type: "Money", nullable: false),
                    BurutTutar = table.Column<decimal>(type: "Money", nullable: false),
                    IndirimTutar = table.Column<decimal>(type: "Money", nullable: false),
                    KdvOrani = table.Column<int>(type: "Int", nullable: false),
                    KdvHaricTutar = table.Column<decimal>(type: "Money", nullable: false),
                    KdvTutar = table.Column<decimal>(type: "Money", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankaHesapId = table.Column<Guid>(type: "UniqueIdentifier", nullable: false),
                    HareketSayisi = table.Column<int>(type: "Int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppMakbuzlar_AppKasaler_KasaId",
                        column: x => x.KasaId,
                        principalTable: "AppKasaler",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppMakbuzHareketler_AppKasaler_KasaId",
                        column: x => x.KasaId,
                        principalTable: "AppKasaler",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppKasaler_Kod",
                table: "AppKasaler",
                column: "Kod");

            migrationBuilder.CreateIndex(
                name: "IX_AppKasaler_OzelKod1Id",
                table: "AppKasaler",
                column: "OzelKod1Id");

            migrationBuilder.CreateIndex(
                name: "IX_AppKasaler_OzelKod2Id",
                table: "AppKasaler",
                column: "OzelKod2Id");

            migrationBuilder.CreateIndex(
                name: "IX_AppKasaler_SubeId",
                table: "AppKasaler",
                column: "SubeId");
